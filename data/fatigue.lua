...
d.rEX = {
    ...
    { time = 480, event = { 'dmgCycle', -1.1, 'animDuration', 1, 'fullHealth', -1 },                    text = "PROTESTERS LINE THE STREETS_",    desc = "-3 MAX HP" },
    { time = 480.5, event = { 'fullHealth', -1}},
    ...
    { time = 660, event = { 'dmgCycle', -.35, 'extraQuestVar', 1.25, 'questFavor', 5, 'questMessiness', 16.2 },                       text = "THE REVOLUTION HAS BEGUN_",       desc = "QUESTS GENERATED BECOMES MUCH MESSIER" },
