...
d.normal = {
    ...
    { time = 480, event = { 'dmgTimerMul', -.05, 'animDuration', 1, 'fullHealth', -2 },                   text = "FATIGUE SETS IN_",          desc = "-2 MAX HP" },
    ...
    { time = 720, event = { 'dmgTimerMul', -.05, 'dmgCycle', -.35, 'animDuration', 1, 'fullHealth', -5 }, text = "THIS IS THE END.",          desc = "-5 MAX HP", color = 'R', final = true },
    { time = 725, event = { 'dmgTimerMul', -.05 } },
    { time = 730, event = { 'dmgTimerMul', -.05 } },
    { time = 735, event = { 'dmgTimerMul', -.05 } },
...
d.rEX = {
    ...
    { time = 360, event = { 'dmgTimerMul', -.1, 'extraQuestVar', .75, 'questMessiness', 2 },                                   text = "YOUR POWER SLIPS_",               desc = "QUESTS GENERATED BECOMES MESSIER" },
    ...
    { time = 660, event = { 'dmgCycle', -.25, 'extraQuestVar', 1.25, 'questFavour', 5, 'questMessiness', 8 },                       text = "THE REVOLUTION HAS BEGUN_",       desc = "QUESTS GENERATED BECOMES MUCH MESSIER" },
...
d.rDP = {
    { time = 20,  event = { 'dmgHeal', -.5, 'questMessiness', .75 }, --[[ 2.5 ]]                       text = "THE RELATIONSHIP STAGNATES_",                        desc = "QUESTS BECOMES A BIT MESSIER",          duration = 10 },
    { time = 40,  event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ 2 ]]                    text = "INSECURITIES GROW STRONGER_",         desc = "QUESTS BECOMES MESSIER",         duration = 10 },
    { time = 60,  event = { 'dmgHeal', -.5, 'animDuration', .5, 'questMessiness', 3 }, --[[ 1.5 ]]  text = "YOU FEEL NEGLECTED_",                        desc = "QUESTS BECOMES MUCH MESSIER",        duration = 10 },
    { time = 80,  event = { 'dmgHeal', 1, 'questMessiness', -.75 }, --[[ 2.5 ]]                        text = "THEY SUCCESSFULLY APOLOGIZE_?",              desc = "QUESTS BECOMES A BIT CLEANER",          duration = 10, color = 'lO' },
    ...
    { time = 200, event = { 'dmgTimerMul', -.2, 'fullHealth', -4 },                            text = "\"THIS TIME WILL BE DIFFERENT\"",                       desc = "-4 MAX HP",   duration = 10 },
    { time = 220, event = { 'dmgHeal', -.5, 'questMessiness', 3 }, --[[ 2 ]]                      text = "SOME HABITS CAN'T BE BROKEN_", desc = "QUESTS BECOMES MUCH MESSIER",        duration = 10 },
    { time = 240, event = { 'extraQuestBase', .2, 'animDuration', 1 } },
    { time = 240, event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ 1.5 ]]                    text = "ALL TRUST HAS WITHERED AWAY_",               desc = "QUESTS BECOMES MESSIER",         duration = 10 },
    { time = 260, event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ 1 ]]                      text = "THEY SET AN ULTIMATUM_",                     desc = "QUESTS BEOMCES MESSIER",         duration = 10 },
    { time = 280, event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ .5 ]]                     text = "YOU CONTEMPLATE YOUR WASTED EFFORT_",             desc = "QUESTS BECOME MESSIER",         duration = 10 },
    { time = 300, event = { 'dmgMul', .25, 'animDuration', 1 },              text = "ONE LAST PAINFUL ARGUMENT_",                 desc = "BOTH PLAYERS RECEIVE 25% MORE DAMAGE",           duration = 10 },
    { time = 320, event = { 'reviveDifficulty', 9999 },                      text = "GOODBYE.",                                   desc = "YOU CAN NO LONGER REVIVE",      duration = 10, color = 'R' },
    { time = 360, event = { 'dmgHeal', 1, 'animDuration', 1, 'questMessiness', -3 }, --[[ 1.5 ]]   text = "\"I MISS YOU\"",                             desc = "QUESTS BECOMES MUCH CLEANER",        duration = 10, color = 'lO' },
    { time = 380, event = { 'dmgHeal', 1, 'questMessiness', -1 }, --[[ 2.5 ]]                      text = "WHAT IF_?",                  desc = "QUESTS BECOMES A BIT CLEANER",          duration = 10, color = 'lO' },
    { time = 400, event = { 'dmgTimerMul', -.1, 'animDuration', 4, 'fullHealth', -12 },         text = "_",                                   desc = "-12 MAX HP", duration = 10, color='R', final = true },
