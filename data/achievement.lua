...
local d = {
    ...
    { -- speed_player
        ...
        scoreSimp = function(n) return n .. " HYPERs" end,
    ...
    { -- supercharged
        ...
        rank = numberRank(0, 20, 40, 65, 90, 120, 239),
    },
    { -- supercharged_plus
        ex = true,
    ...
    { -- zenith_speedrun
        ...
        desc = [[Reach F10 as fast as possible while retaining HYPERSPEED without any mods]],
        quote = [[F10 Hyper%]],
        comp = '<',
        scoreSimp = function(time) return string.format("%.2fs", time) end,
    ...
    { -- zenith_speedrun_plus
        ...
        name = "Zenith Speedrun+",
        desc = [[Reach F10 as fast as possible while retaining HYPERSPEED]],
        quote = [[F10 Any%]],
        comp = '<',
        scoreSimp = function(time) return string.format("%.2fs", time) end,
        scoreFull = function(time) return string.format("%.1f m/s", Floors[9].top / time) end,
    ...
    { -- zenith_speedrunner
        ...
        desc = [[Sum of best HYPERSPEED times with each mod]],
        quote = [[F10 All%]],
        comp = '<',
        scoreSimp = function(time) return string.format("%.2fs", time) end,
    ...
    { -- divine_speedrunner
        ...
        desc = [[Sum of best HYPERSPEED time with each rev mod]],
        quote = [[F10 All+%]],
        comp = '<',
        scoreSimp = function(time) return string.format("%.2fs", time) end,
    ...
    { -- EX
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3993.1),
    },
    { -- NH
        id = 'NH',
        name = "Temperance",
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3837.4),
    },
    { -- MS
        id = 'MS',
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 5284),
    },
    { -- GV
        id = 'GV',
        name = "The Tower",
    ...
    { -- VL
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 5715.2),
    },
    { -- DH
        id = 'DH',
        name = "The Devil",
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 4428),
    },
    { -- IN
        id = 'IN',
        name = "The Hermit",
    ...
    { -- AS
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 5288.1),
    },
    { -- DP
        id = 'DP',
        name = "The Lovers",
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 6186.8),
    ...
    { -- GVIN
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3272.8),
    },
    { -- ASNH
        id = 'ASNH',
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3890.3),
    },
    { -- DPEX
        id = 'DPEX',
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3036.5),
    },
    { -- GVNH
        id = 'GVNH',
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 2186),
    },
    { -- DHMSNH
        id = 'DHMSNH',
        name = "Deadlock",
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 2863.1),
    },
    { -- DHEXNH
        id = 'DHEXNH',
    ...
    { -- ASEXVL
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 2706.2),
    },
    { -- swamp_water_lite
        id = 'swamp_water_lite',
    ...
    { -- rMS
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3050.8),
        hide = function() return GAME.completion.MS == 0 end,
    },
    { -- rGV
        id = 'rGV',
    ...
    { -- rVL
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3293.9),
    ...
    { -- rDH
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 2340.2),
    ...
    { -- rIN
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 3118.3),
    ...
    { -- rAS
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 4228.9),
    ...
    { -- ASMSrDHrIN
        ...
        credit = "@Tizago",
        rank = floorRank(1, 26, 2, 120, 3, 4, 5),
    ...
    { -- talentless
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 2909.1),
    },
    { -- quest_rationing
        id = 'quest_rationing',
    ...
    { -- guardian_angel
        ...
        scoreSimp = heightNumber,
        rank = numberRank(0, 626, 942, 1620, 2000, 2600, 6017.6),
    },
    { -- carried
        ex = true,
        id = 'carried',
    ...
    { -- overprotection
        ...
        id = 'overprotection',
        name = "Overprotection",
        desc = [[HFD while keeping both players' HP above 16/22, with rDP]],
    ...
    { -- the_escape_artist
        ...
        rank = numberRank(0, 10, 26, 40, 60, 80, 116),
    },
    { -- the_artist_trinity
        ex = true,
    ...
    { -- the_masterful_juggler
        ...
        desc = [[Highest Back-to-Back chain reached without an imperfect pass, with rMS rGV rIN]],
    ...
    { -- autoplay_is_awesome
        ...
        desc = [[HFD without manually selecting a card, with rNH MS rGV AS]],
        quote = [["All the words, of a melody of rain. Resonating in ripples, Dreams of human remain."]],
        credit = "@obsidian",
        rank = floorRank(1, 2, 3, 4, 5, 7, 8),
    ...
    { -- zero_to_sixty
        ...
        id = 'zero_to_sixty',
        name = "Zero-to-sixty",
        desc = [[Fastest time to reach HYPERSPEED using NH rVL AS]],
        quote = [["Didn't even need the 1-foot rollout!"]],
        comp = '<',
        credit = "@FCSplayz",
        scoreSimp = function(time) return string.format("%.2fs", time) end,
        rank = numberRankRev(26, 20, 15, 12.5, 10, 8, 5),
    ...
    { -- under_the_radar
        ...
        desc = [[Fastest time reaching F6 without entering HYPERSPEED with VL IN AS]],
    ...
    { -- lovers_promise
        ...
        scoreSimp = heightNumber,
        rank = floorRank(1, 3, 5, 7, 9, 10, 7377.1),
        type = 'event',
    },
    ...
    { -- hardcore_beginning
        ex = true,
        id = 'hardcore_beginning_legacy',
        name = "Hardcore Beginning (Legacy)",
        ...
        rank = numberRankRev(62, 50, 42, 32, 26, 20, 16.2),
    ...
    { -- cut_off
        ...
        id = 'cut_off',
        name = "Cut Off",
        desc = [[Lose HYPERSPEED above 1600m on F9]],
    ...
    { -- worn_out
        ...
        id = 'worn_out',
        name = "Worn Out",
        desc = [[Reach F10 with HYPERSPEED after retaining it for 5 minutes]],
    ...
    { -- abyss_weaver
        ...
        id = 'abyss_weaver',
        name = "Abyss Weaver",
        desc = [[Enter HYPERSPEED with 15+ mod points]],
    ...
    { -- blazing_speed
        ...
        id = 'blazing_speed',
        name = "Blazing Speed",
        desc = [[Reach F10 while maintaining GIGASPEED]],
