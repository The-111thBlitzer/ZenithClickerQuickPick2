...
d.rDP = {
    { time = 60,  event = { 'dmgHeal', -.5, 'questMessiness', .75 }, --[[ 2.5 ]]                       text = "THE RELATIONSHIP STAGNATES_",                        desc = "QUESTS BECOMES A BIT MESSIER",          duration = 10 },
    { time = 90,  event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ 2 ]]                    text = "INSECURITIES GROW STRONGER_",         desc = "QUESTS BECOMES MESSIER",         duration = 10 },
    { time = 120,  event = { 'dmgHeal', -.5, 'animDuration', .5, 'questMessiness', 3 }, --[[ 1.5 ]]  text = "YOU FEEL NEGLECTED_",                        desc = "QUESTS BECOMES MUCH MESSIER",        duration = 10 },
    { time = 150,  event = { 'dmgHeal', 1, 'questMessiness', -.75 }, --[[ 2.5 ]]                        text = "THEY SUCCESSFULLY APOLOGIZE_?",              desc = "QUESTS BECOMES A BIT CLEANER",          duration = 10, color = 'lO' },
    { time = 165,  event = { 'extraQuestBase', .2 } },
    { time = 180, event = { 'dmgHeal', .5, 'questMessiness', -5 }, --[[ 3 ]]                        text = "THINGS ARE BACK TO HOW THEY USED TO BE_!",   desc = "QUESTS BECOMES MUCH CLEANER",        duration = 10, color = 'lO' },
    { time = 210, event = { 'dmgHeal', -.5, 'animDuration', .5, 'questMessiness', 1.5 }, --[[ 2.5 ]]   text = "THE WEIGHT OF WORDS UNSPOKEN_",       desc = "QUESTS BECOMES MESSIER",         duration = 10 },
    { time = 240, event = { 'dmgHeal', -1.5, 'questMessiness', 2.5, 'extraQuestVar', .75 }, --[[ 1 ]]                       text = "\"WHY CAN'T YOU JUST LISTEN TO ME\"",      desc = "QUESTS BECOMES MUCH MESSIER",        duration = 10 },
    ...
    { time = 300, event = { 'dmgHeal', 1.5, 'animDuration', 1, 'questMessiness', -2 }, --[[ 2.5 ]] text = "YOU MAKE THE SAME PROMISE AGAIN_",                     desc = "QUESTS BECOMES CLEANER",         duration = 10, color = 'lO' },
    ...
    { time = 390, event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ 1.5 ]]                    text = "ALL TRUST HAS WITHERED AWAY_",               desc = "QUESTS BECOMES MESSIER",         duration = 10 },
    { time = 420, event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ 1 ]]                      text = "THEY SET AN ULTIMATUM_",                     desc = "QUESTS BEOMCES MESSIER",         duration = 10 },
    { time = 450, event = { 'dmgHeal', -.5, 'questMessiness', 1.5 }, --[[ .5 ]]                     text = "YOU CONTEMPLATE YOUR WASTED EFFORT_",             desc = "QUESTS BECOME MESSIER",         duration = 10 },
    ...
    { time = 540, event = { 'dmgHeal', 1, 'animDuration', 1, 'questMessiness', -3 }, --[[ 1.5 ]]   text = "\"I MISS YOU\"",                             desc = "QUESTS BECOMES MUCH CLEANER",        duration = 10, color = 'lO' },
    { time = 570, event = { 'dmgHeal', 1, 'questMessiness', -1 }, --[[ 2.5 ]]                      text = "WHAT IF_?",                  desc = "QUESTS BECOMES A BIT CLEANER",          duration = 10, color = 'lO' },
