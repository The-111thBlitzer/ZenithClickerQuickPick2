...
d.normal = {
    ...
    { time = 540, event = { 'dmgCycle', -.5, 'dmgMul', .25 },                          text = "YOUR BODY GROWS WEAK_",     desc = "RECEIVE 25% MORE DAMAGE" },
...
d.rEX = {
    ...
    { time = 660, event = { 'dmgCycle', -.5, 'extraQuestVar', 1.25, 'questFavor', 5, 'questMessiness', 16.2 },                       text = "THE REVOLUTION HAS BEGUN_",       desc = "QUESTS GENERATED BECOMES MUCH MESSIER" },
